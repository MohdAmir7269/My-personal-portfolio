...
//           <div className="row p-3"style={{height:"640px"}} >
...
//               <label htmlFor="" className="text-light ms-5">Full Name</label>
//               <br />
//               <input  type="text" name="Enter your name" placeholder="Enter your Name" className=" center border border-primary ms-5  rounded-3 " style={{height:"40px",width:"80%",backgroundColor:"black"}}  id="" /> <br /> <br />
//               <label htmlFor="" className="text-light ms-5">Enter your Email</label>
              
//               <input type="text" name="Enter your Email" placeholder="Enter your Email" className="  border border-primary  rounded-3 ms-5"  style={{height:"40px",width:"80%",backgroundColor:"black"}} id="" /><br /> <br />
//               <label htmlFor="" className="text-light ms-5">Phone Number</label>
              
//               <input type="text" name="Enter your Phone Number" placeholder="Enter your phone Number" className="  border border-primary rounded-3 ms-5"  style={{height:"40px",width:"80%",backgroundColor:"black"}}  id="" /> <br /> <br />
            
//               <label htmlFor="" className="text-light ms-5">Message</label>
//               <br />
//               <input type="text" name="Type your message..." placeholder="Type your message..." className=" pb-5   border border-primary rounded-3 ms-5"  style={{height:"22%",width:"80%",backgroundColor:"black"}}  id="" />
               
//                <button className="bg-primary border-0 text-white fw-bold rounded-3 ms-5 mt-4 " style={{height:"40px",width:"80%"}}  >Send Message</button>
//               <div>
//               </div>
//             </div>
...
//                   alt="Profile"
//                   style={{ width: "90px", border: "2px solid white" }} /></div>
//                    <div className="text-center text-white">Phone:  <Link to="/" className="text-white  ">7269096806</Link></div>
//                    <div className="text-center text-white">Email:  <Link to="/" className="text-white  ">mohdamir7269@gmail.com</Link></div>
//                  <div className="mt-3 mx-5 px-5   ">
//                      <button className="  text-white border-0  mx-3 py-2 rounded-2 " style={{backgroundColor:"blueviolet"}}>View Resume</button>
//               <button className="bg-white text-black border border-dark rounded-2 py-2 ">Contact Me</button>
//                  </div>
//             </div>
//           </div>
//         </div>
