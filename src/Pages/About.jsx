...
//               <h4 className="text-white  mt-3 px-5 ">I'm a <span className="text-primary">MERN Stack Developer</span></h4> <br />
//               <p className="text-white  text-state mt-3 px-5 " style={{ fontSize: "17px" }} >
//                 Hi, I'm Mohd Amir, a MERN Stack Developer from Lucknow, Uttar Pradesh, India. I enjoy building full-stack web applications that are fast, responsive, and user-friendly. <br /><br />
//                 I connect front-end and back-end seamlessly using RESTful APIs, manage state efficiently with Redux, and focus on secure, scalable, and responsive web apps.
//               </p>
//               <div className="row">
//                 <h4 className="text-white mx-5">Skills</h4>
//                 <div className="col-sm-10  mx-5 py-3">
//                   <button className="border-0 btn btn-primary me-3">Javascript</button>
//                   <button className="border-0 btn btn-primary me-3">React</button>
//                   <button className="border-0 btn btn-primary me-3">Node.js</button>
//                   <button className="border-0 btn btn-primary me-3">Git</button>
//                   <div className="mt-3">

//                     <button className="border-0 btn btn-primary me-3">NPM</button>
//                     <button className="border-0 btn btn-primary me-3">Express</button>
//                     <button className="border-0 btn btn-primary me-3">MongoDB</button>
//                   </div>
//                 </div>
//               </div>
//               <div>
